...
public class InnerDockerProxy extends AbstractContainer {
  ...
  private static final int PROXY_PORT = 3376;

  private MesosContainer mesosContainer;

  protected InnerDockerProxy(DockerClient dockerClient, MesosContainer mesosContainer) {
    super(dockerClient);
  ...
  protected CreateContainerCmd dockerCommand() {
    return dockerClient
        ...
        .withPortBindings(PortBinding.parse("0.0.0.0:" + PROXY_PORT + ":" + mesosContainer.getDockerPort()))
