 ...
 * <p> For example, the simplest cluster you could create is:
 *
 * <code>
 * new ClusterArchitecture.Builder().build();
 * </code>
 *
 * <p>Which would create a cluster comprising of ZooKeeper, a Mesos Master and a single Mesos agent. This is the minimum viable cluster.
 ...
 * </code>
 *
 * <p>To add more zookeepers, masters or agents, you can simply use (note that when adding masters or agents, zookeeper must be added first, since Mesos requires a link to the ZooKeeper container.):
 *
 * <code>
 * new ClusterArchitecture.Builder().withZooKeeper().withZooKeeper().withAgent().withAgent().withAgent().build();
 * </code>
 * <p>If you need to provide a custom Mesos(Agent/Master) you can provide your own. This will inject a reference to the zooKeeper container, so the Mesos can generate the zkUrl to ZooKeeper.
 *
 * <code>
 * new ClusterArchitecture.Builder().withZooKeeper().withAgent(zooKeeper -&gt; new MyAgent(..., zooKeeper)).build();
 * </code>
 *
 * <p>If you want to provide a completely custom container, you can inject an instance of any other container using a filter.
 ...
 * </code>
 *
 * <p>Finally, for the super-leet, you could inject a reference of your own container, into a new container:
 *
 * <code>
...
public class ClusterArchitecture {
    ...
    public static class Builder {
        ...
        /**
         * Return the containers currently in the cluster. Note that this method is not checked. If you want to start containers, use {@link Builder#build()}
         *
         ...
         *
         * @param zooKeeperConfig TODO(mwl)
         * @return TODO(mwl)
         */
